  ...
  return (
    <CardTilt>
      <Link
        ...
        className={cn(
          "group relative flex flex-col gap-4 rounded-2xl border-2 border-ink bg-surface p-5 shadow-[4px_4px_0_0_var(--ink)] transition-shadow duration-200 hover:shadow-[6px_6px_0_0_var(--ink)]",
        )}
      >
